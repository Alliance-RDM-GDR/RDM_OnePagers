---
title: "TreeGen: File Tree Generator for Scientific Data" 
author: 
...
keywords: 
  ...
  - Data sharing
links: 
  - text: "TreeGen: File Tree Generator for Scientific Data"
...
🌍 <a href="https://alliance-rdm-gdr.github.io/RDM_OnePager/RDM_TreeGen_fr.html" target="_blank">🇫🇷 Version Française</a>
</div>
:::

## What is TreeGen?

TreeGen is a desktop application designed to help researchers and data curators visualize, describe, and export the structure of folders and files in a scientific dataset. It offers a simple and dynamic interface to:
