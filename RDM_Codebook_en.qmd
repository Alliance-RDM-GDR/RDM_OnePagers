...
🌍 <a href="https://alliance-rdm-gdr.github.io/RDM_OnePager/RDM_Codebook_fr.html" target="_blank">🇫🇷 Version Française</a>
</div>
:::
...
Creating codebooks is a good scientific practice that should be implemented during the research process. Keep the format as simple as possible. The web-based [codebook generator](https://alliance-rdm-gdr.github.io/RDM_Codebook_App/) allows the user to download a .CSV codebook derived from a given data table.
