...
#let poster(
  ...
  // Set the body font.
  set text(font: "arial", size: 21pt)
  let sizes = size.split("x")
  let width = int(sizes.at(0)) * 1in
  let height = int(sizes.at(1)) * 1in
  univ_logo_scale = int(univ_logo_scale) * 1.1%
  ...
  set page(
    ...
    footer: [
      ...
      #block(
        ...
        radius: 10pt,
        [
          #text(font: "PT Sans", size: footer_url_font_size, footer_url) 
          #h(1fr) 
          #text(size: footer_text_font_size, smallcaps(footer_text)) 
          #h(1fr) 
          #text(font: "PT Sans", size: footer_url_font_size, footer_email_ids)
        ]
      )
    ]
  )
